...
export const web3Faqs = [
    {
        question: "What is a blockchain?",
        answer: "A blockchain is a distributed database that is shared among the nodes of a computer network. It stores information electronically in digital format and is best known for its crucial role in cryptocurrency systems for maintaining a secure and decentralized record of transactions."
    },
    {
        question: "What are smart contracts?",
        answer: "Smart contracts are self-executing contracts with the terms of the agreement directly written into code. They automatically execute, control, or document legally relevant events and actions according to the terms of a contract or an agreement."
    },
    {
        question: "How do I set up a cryptocurrency wallet?",
        answer: "Setting up a cryptocurrency wallet typically involves choosing a wallet type (software or hardware), downloading the necessary software, and securing your wallet with a strong password and backup recovery phrase."
    },
    {
        question: "What is gas in Ethereum?",
        answer: "Gas refers to the computational effort required to execute operations like transactions and smart contracts on the Ethereum network. Users must pay gas fees to compensate for the computing energy required to process and validate transactions on the blockchain."
    },
    {
        question: "How can I ensure the security of my digital assets?",
    ...
    {
        question: "What are the main risks associated with using cryptocurrencies?",
        answer: "The main risks include volatility in cryptocurrency prices, potential regulatory changes, security threats, and the irreversible nature of blockchain transactions."
    },
    {
...
export const accountFaqs = [
    ...
    },
    {
        ...
        answer: "If you wish to close your account, please contact customer support for assistance."
    }
];
...
export const paymentFaqs = [
    ...
    },
    {
        ...
        answer: "Yes, our platform uses industry-standard encryption to protect your payment details and ensure the security of your financial information."
    },
    {
        question: "Can I get a refund for transactions made in cryptocurrencies?",
        answer: "Due to the nature of blockchain and cryptocurrencies, transactions made in crypto are typically not refundable. However, please contact support for specific issues."
    },
    {
