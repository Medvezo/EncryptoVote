...
export default function TwinkleSpikes({ size }: { size?: string }) {
	const svgRef = useRef<SVGSVGElement>(null); // Specify the type for the ref
    const [lineStates, setLineStates] = useState<any>([]);
    ...
    useEffect(() => {
        const timer = setInterval(() => {
            setLineStates((currentStates:any) =>
