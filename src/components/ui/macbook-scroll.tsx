...
export const MacbookScroll = ({
  ...
  const translate = useTransform(scrollYProgress, [0, 0.7], [0, 800]);
  ...
  return (
    <div
      ref={ref}
      className="min-h-[100vh] lg:min-h-[200vh]  flex flex-col items-center py-0 md:py-80 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50"
    >
      <motion.h2
        style={{
